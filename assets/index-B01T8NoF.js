...
`)+`
`+S);const P=C+y+c,R=C+S+u,F=__(o,o.VERTEX_SHADER,P),I=__(o,o.FRAGMENT_SHADER,R);o.attachShader(A,F),o.attachShader(A,I),t.index0AttributeName!==void 0?o.bindAttribLocation(A,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(A,0,"position"),o.linkProgram(A);function U(k){if(n.debug.checkShaderErrors){const q=o.getProgramInfoLog(A)||"",le=o.getShaderInfoLog(F)||"",ue=o.getShaderInfoLog(I)||"",G=q.trim(),Q=le.trim(),$=ue.trim();let X=!0,ie=!0;if(o.getProgramParameter(A,o.LINK_STATUS)===!1)if(X=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(o,A,F,I);else{const se=S_(o,F,"vertex"),O=S_(o,I,"fragment");Tt("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(A,o.VALIDATE_STATUS)+`
